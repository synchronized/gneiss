...
function(gneiss_resolve_granit_runtime)
  ...
  gneiss_fetch_granit()
  if(NOT TARGET granit::granit OR NOT TARGET granit::window OR NOT TARGET granit::input)
    message(FATAL_ERROR "下载的 Granit 未提供 granit::granit、granit::window 和 granit::input 目标")
  endif()
endfunction()
