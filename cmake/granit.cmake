...
function(gneiss_resolve_granit_runtime)
  if(TARGET granit::granit AND TARGET granit::window)
  ...
  if(granit_provider STREQUAL "AUTO" OR granit_provider STREQUAL "PACKAGE")
    find_package(granit 0.3 CONFIG QUIET COMPONENTS Window)
    if(TARGET granit::granit AND TARGET granit::window)
      message(STATUS "Gneiss uses the installed Granit runtime package")
      return()
    endif()
    if(granit_provider STREQUAL "PACKAGE")
      message(FATAL_ERROR "未找到 Granit 0.3 runtime package（granit::granit、granit::window）")
    endif()
  ...
  gneiss_fetch_granit()
  if(NOT TARGET granit::granit OR NOT TARGET granit::window)
    message(FATAL_ERROR "下载的 Granit 未提供 granit::granit 和 granit::window 目标")
  endif()
endfunction()
