...
function(gneiss_resolve_granit_window)
  if(TARGET granit::window)
    message(STATUS "Gneiss reuses the existing granit::window target")
    return()
  endif()
  ...
  if(granit_provider STREQUAL "AUTO" OR granit_provider STREQUAL "PACKAGE")
    ...
    if(TARGET granit::window)
      message(STATUS "Gneiss uses the installed Granit Window package")
      return()
    endif()
    if(granit_provider STREQUAL "PACKAGE")
      message(FATAL_ERROR "未找到 Granit 0.3 Window package（granit::window）")
    endif()
  ...
  if(NOT TARGET granit::window)
    message(FATAL_ERROR "下载的 Granit 未提供 granit::window 目标")
  endif()
endfunction()
