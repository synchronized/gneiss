...
/** 属性值的固定 ABI 类别。 */
typedef uint32_t gneiss_property_kind;
#define GNEISS_PROPERTY_KIND_INVALID UINT32_C(0)
#define GNEISS_PROPERTY_KIND_BOOL UINT32_C(1)
#define GNEISS_PROPERTY_KIND_INT64 UINT32_C(2)
#define GNEISS_PROPERTY_KIND_UINT64 UINT32_C(3)
#define GNEISS_PROPERTY_KIND_FLOAT32 UINT32_C(4)
#define GNEISS_PROPERTY_KIND_FLOAT64 UINT32_C(5)
#define GNEISS_PROPERTY_KIND_STRING UINT32_C(6)
#define GNEISS_PROPERTY_KIND_TYPE_ID UINT32_C(7)
#define GNEISS_PROPERTY_KIND_VEC3 UINT32_C(8)
#define GNEISS_PROPERTY_KIND_QUATERNION UINT32_C(9)
...
#define GNEISS_FIELD_INFO_VERSION_1_SIZE ((uint32_t)sizeof(gneiss_field_info))
#define GNEISS_FIELD_INFO_INIT                                                                     \
  {                                                                                                \
      (uint32_t)sizeof(gneiss_field_info),                                                         \
      GNEISS_NULL_FIELD_ID,                                                                        \
      {{0}},                                                                                       \
      UINT32_C(0),                                                                                 \
      NULL,                                                                                        \
      UINT32_C(0),                                                                                 \
      GNEISS_PROPERTY_KIND_INVALID,                                                                \
      UINT32_C(0)}
...
#define GNEISS_TYPE_INFO_VERSION_1_SIZE ((uint32_t)sizeof(gneiss_type_info))
#define GNEISS_TYPE_INFO_INIT                                                                      \
  {(uint32_t)sizeof(gneiss_type_info), {{0}}, UINT32_C(0), NULL, UINT32_C(0), NULL, UINT32_C(0)}
...
gneiss_type_registry_create(gneiss_type_registry* out_registry);

/** 销毁 Registry；销毁后所有借用元数据立即失效。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result
gneiss_type_registry_destroy(gneiss_type_registry registry);
 ...
 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result
gneiss_type_registry_register(gneiss_type_registry registry, const gneiss_type_desc* desc);

/** 冻结前为已注册字段绑定访问器；相同绑定重复调用幂等成功。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result gneiss_type_registry_bind_property(
...
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result
gneiss_type_registry_freeze(gneiss_type_registry registry);

/** 返回 Registry 是否已经冻结。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result
gneiss_type_registry_is_frozen(gneiss_type_registry registry, uint8_t* out_is_frozen);

/** 返回冻结 Registry 中的类型数量；冻结前返回未就绪。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result
gneiss_type_registry_type_count(gneiss_type_registry registry, uint32_t* out_count);

/** 按 Type ID 字节序返回确定性排序后的类型；返回借用元数据。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result gneiss_type_registry_type_at(
    gneiss_type_registry registry, uint32_t index, gneiss_type_info* out_type);

/** 按稳定 Type ID 查询类型；返回借用元数据。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result gneiss_type_registry_find_type(
    gneiss_type_registry registry, gneiss_type_id id, gneiss_type_info* out_type);

/** 按完整字段身份查询字段；返回借用元数据。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result
gneiss_type_registry_find_field(gneiss_type_registry registry, gneiss_type_id type_id,
                                gneiss_field_id field_id, gneiss_field_info* out_field);

/** 读取冻结 Registry 中的属性；适配器返回的字符串为借用值。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result gneiss_type_registry_get_property(
    gneiss_type_registry registry, gneiss_type_id type_id, gneiss_field_id field_id,
    gneiss_property_target target, gneiss_property_value* out_value);

/** 校验并写入冻结 Registry 中的属性；失败时适配器必须保持目标原值。 */
GNEISS_EXPERIMENTAL GNEISS_API gneiss_result gneiss_type_registry_set_property(
    gneiss_type_registry registry, gneiss_type_id type_id, gneiss_field_id field_id,
    gneiss_property_target target, const gneiss_property_value* value);
